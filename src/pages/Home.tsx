...
const Home = () => {
    ...
    const [participants] = useState([
        ...
        { id: 3, name: 'Manav Garg', score: 90 },
        { id: 4, name: 'Pari Goyal', score: 90 },
        { id: 5, name: 'Sanchita Das', score: 51 },
        { id: 6, name: 'Sumit Kumar', score: 16 },
        { id: 7, name: 'Tanish Kashyap', score: 123 },
        { id: 8, name: 'Utsav Garg', score: 123 },
        { id: 9, name: 'Yashasvini Sharma', score: 4 },
        { id: 10, name: 'Khrish Chauhan', score: 19 },
        { id: 11, name: 'Himanshu', score: 82 },
